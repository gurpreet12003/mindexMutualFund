...
export const FAQ = () => {
  ...
  return (
    <Scroll>
    <section id="faqs" className="py-20 bg-white border-b border-gray-100 scroll-mt-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            Everything you need to know about Mindex Capital, mutual fund safety, SEBI guidelines, and our portfolio planning services.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`border rounded-2xl transition-all duration-300 overflow-hidden ${
                  isOpen ? 'border-red-600 bg-red-50/20 shadow-md' : 'border-gray-200 bg-white hover:border-gray-300'
                }`}
              >
                <button
                      onClick={() => {
